...
--
-- Name: properties fk_properites_elements; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_properites_elements FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
